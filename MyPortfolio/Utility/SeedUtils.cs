...
namespace MyPortfolio.Utility
{
    public static class SeedUtils
    {
        ...
        internal static async Task SetAssetSchema(IAssetTypeRepo _assetTypeRepo, IAssetCategoryRepo _assetCategoryRepo)
        {
            ...
            List<AssetType> assetTypesListToAdd = new List<AssetType>()
                {
                    ...
                    new AssetType(){ Name = "Amazon", CategoryId = AssetStaticUtils.GetCategoryFromName("Account", currentCategoryList.ToList())!.Id },
